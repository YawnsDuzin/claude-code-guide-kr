...
1. 혼자 작은 작업: 단일 에이전트 + [02-프롬프트템플릿](../02-프롬프트템플릿(prompts)/)의 템플릿
...
- Claude Code의 서브에이전트 기능 설명: [03-주요기능/05-서브에이전트](../../03-주요기능(features)/05-서브에이전트(subagents).md)
- 이 폴더는 **협업 패턴/실전**, 저 문서는 **Claude Code 기능 설명**이다.
