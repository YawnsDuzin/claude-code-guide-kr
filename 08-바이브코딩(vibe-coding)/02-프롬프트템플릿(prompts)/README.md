...
> 각 원칙의 상세 설명, before/after 예시, 고급 기법은 [07-최적화/01-프롬프트엔지니어링](../../07-최적화(optimization)/01-프롬프트엔지니어링(prompt-engineering).md)을 참조하세요.

| # | 원칙 | 핵심 |
|---|------|------|
| 1 | **역할 (Role)** | 에이전트의 기본 역할을 고정 |
| 2 | **참조 (Context)** | 먼저 읽을 문서/파일을 경로로 명시 |
| 3 | **목적 (Intent)** | "왜 하는지" 한 줄 |
| 4 | **범위 (Scope)** | 건드려도 되는 것 / 안 되는 것 |
| 5 | **완료 기준 (Done Criteria)** | 체크박스 3~7개 |
| 6 | **제약 (Constraints)** | 성능, 보안, 호환성, 금지 패턴 |
