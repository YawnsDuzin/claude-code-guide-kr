...
Claude Code는 CLI(명령줄) 도구이지만, **VS Code**에 확장 프로그램을 설치하여 IDE 안에서 직접 사용할 수 있습니다. 터미널과 에디터를 오가는 번거로움 없이, 코드를 보면서 바로 Claude와 대화할 수 있습니다.
...
**참고**: 단축키는 VS Code 버전과 설정에 따라 다를 수 있습니다. Settings > Keyboard Shortcuts에서 커스터마이징 가능합니다.
